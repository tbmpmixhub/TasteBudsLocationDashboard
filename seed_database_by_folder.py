...
# Turn into lookup dicts keyed by their parent folder --> { Path(folder) : Path(to CSV file) }
item_map = {csv_file.parent: csv_file for csv_file in item_files}
mod_map  = {csv_file.parent: csv_file for csv_file in mod_files}
